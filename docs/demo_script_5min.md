...
> （可選 30 秒）切到 **AI Analyst** 分頁：`[截圖 / Screenshot: 03_ai_analyst_brief.png ? 04_evidence_gap_analyzer.png → 05_knowledge_qa_rag.png]`
...
`[截圖 / Screenshot: 10_full_ai_assisted_optional.png]`
